...
# Combining both datasets into one comprehensive dataset
# Using np.concatenate to merge the two arrays along the first axis (rows)
combined_employees = np.concatenate((full_time_employees, part_time_employees), axis=0)

# Printing the combined dataset in the desired format
